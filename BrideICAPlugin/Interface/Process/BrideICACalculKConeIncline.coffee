...
class BrideICACalculKConeIncline extends MatriceItem
    constructor: ( @param = {} ) ->
        super()
...
#         console.log "r = " + r
        ...
        B = math.matrix( [ [ -cosd(phi) / L, -sind(phi) / L, 0, cosd(phi) / L, sind(phi) / L, 0 ] ] )
...
#         console.log B.subset(math.index(0, 0))
        ...
        k22 = (p)->
            (B.subset(math.index(0,1))*(D.subset(math.index(0,0))*B.subset(math.index(0,1))+D.subset(math.index(0,1))*((1-p)*sind(phi)*sind(phi)/r+(1-3*p*p+2*p*p*p)*cosd(phi)*cosd(phi)/r))+((1-p)*sind(phi)*sind(phi)/r+(1-3*p*p+2*p*p*p)*cosd(phi)*cosd(phi)/r)*(D.subset(math.index(1,0))*B.subset(math.index(0,1))+D.subset(math.index(1,1))*((1-p)*sind(phi)*sind(phi)/r+(1-3*p*p+2*p*p*p)*cosd(phi)*cosd(phi)/r))+(1/(L*L)*(-6+12*p)*cosd(phi))*(D.subset(math.index(2,2))*(1/(L*L)*(-6+12*p)*cosd(phi))+D.subset(math.index(2,3))*(-1/L*(-6*p+6*p*p)*sind(2*phi)/(2*r)))+(-1/L*(-6*p+6*p*p)*sind(2*phi)/(2*r))*(D.subset(math.index(3,2))*(1/(L*L)*(-6+12*p)*cosd(phi))+D.subset(math.index(3,3))*(-1/L*(-6*p+6*p*p)*sind(2*phi)/(2*r))))*r*L   
        ...
        k24 = (p)->
            (B.subset(math.index(0,1))*(D.subset(math.index(0,0))*B.subset(math.index(0,3))+D.subset(math.index(0,1))*(p*sind(phi)*cosd(phi)/r-(3*p*p-2*p*p*p)*sind(2*phi)/(2*r)))+((1-p)*sind(phi)*sind(phi)/r+(1-3*p*p+2*p*p*p)*cosd(phi)*cosd(phi)/r)*(D.subset(math.index(1,0))*B.subset(math.index(0,3))+D.subset(math.index(1,1))*(p*sind(phi)*cosd(phi)/r-(3*p*p-2*p*p*p)*sind(2*phi)/(2*r)))+(1/(L*L)*(-6+12*p)*cosd(phi))*(D.subset(math.index(2,2))*(-1/(L*L)*(6-12*p)*sind(phi))+D.subset(math.index(2,3))*(-1/L*(6*p-6*p*p)*sind(2*phi)/(2*r)))+(-1/L*(-6*p+6*p*p)*sind(2*phi)/(2*r))*(D.subset(math.index(3,2))*(-1/(L*L)*(6-12*p)*sind(phi))+D.subset(math.index(3,3))*(1/L*(6*p-6*p*p)*sind(phi)*sind(phi)/r)))*r*L
        ...
        k66 = (p)->
            (B.subset(math.index(0,5))*(D.subset(math.index(0,0))*B.subset(math.index(0,5))+D.subset(math.index(0,1))*(-L*(-p*p+p*p*p)*cosd(phi)/r))+(-L*(-p*p+p*p*p)*cosd(phi)/r)*(D.subset(math.index(1,0))*B.subset(math.index(0,5))+D.subset(math.index(1,1))*(-L*(-p*p+p*p*p)*cosd(phi)/r))+(-1/L*(-2+6*p))*(D.subset(math.index(2,2))*(-1/L*(-2+6*p))+D.subset(math.index(2,3))*((-2*p+3*p*p)*sind(phi)/r))+((-2*p+3*p*p)*sind(phi)/r)*(D.subset(math.index(3,2))*(-1/L*(-2+6*p))+D.subset(math.index(3,3))*((-2*p+3*p*p)*sind(phi)/r)))*r*L
